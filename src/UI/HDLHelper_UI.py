...
class Ui_HDLHelper(object):
    ...
    def retranslateUi(self, HDLHelper):
        ...
        self.antirrebotes_button.setText(_translate("HDLHelper", "Antirrebotes"))
        self.clock_divisor_button.setText(_translate("HDLHelper", "Clock Divisor"))
        self.filter_generator_button.setText(_translate("HDLHelper", "Filter generator"))
        self.auto_improve_button_3.setText(_translate("HDLHelper", "Communication libraries"))
