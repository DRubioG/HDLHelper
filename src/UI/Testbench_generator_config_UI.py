...
class Ui_testbench_generator_config(object):
    def setupUi(self, testbench_generator_config):
        ...
        testbench_generator_config.resize(476, 591)
        ...
        self.pushButton_save.setGeometry(QtCore.QRect(370, 550, 91, 31))
        self.pushButton_save.setObjectName("pushButton_save")
        self.pushButton_cancel = QtWidgets.QPushButton(testbench_generator_config)
        self.pushButton_cancel.setGeometry(QtCore.QRect(250, 550, 91, 31))
        ...
        self.textEdit_default_config.setGeometry(QtCore.QRect(30, 420, 411, 111))
        ...
        self.label_2.setGeometry(QtCore.QRect(30, 400, 211, 17))
        self.label_2.setObjectName("label_2")
        self.checkBox_comments = QtWidgets.QCheckBox(testbench_generator_config)
        self.checkBox_comments.setGeometry(QtCore.QRect(30, 370, 281, 23))
    ...
    def retranslateUi(self, testbench_generator_config):
        ...
        self.checkBox_comments.setText(_translate("testbench_generator_config", "Generate with the comments"))
